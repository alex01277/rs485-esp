String read_u1() {  uint32_t uu1 = mb.Hreg(17)<<16 | mb.Hreg(16); 
                    float t      = *(float*)&uu1; 
                    return String(t,1);}
String read_u2() {  uint32_t uu1 = mb.Hreg(19)<<16 | mb.Hreg(18); 
                    float t      = *(float*)&uu1; 
                    return String(t,1);}
String read_u3() {  uint32_t uu1 = mb.Hreg(21)<<16 | mb.Hreg(20); 
                    float t      = *(float*)&uu1; 
                    return String(t,1);}
