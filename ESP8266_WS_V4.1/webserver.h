...
void sendSMS(String ssRecipient,String ssMessage)
 ...
 // openssl s_client -connect userarea.sms-assistent.by:443 < /dev/null 2>/dev/null | openssl x509 -fingerprint -noout -in /dev/stdin
     if (http.begin(url,"5E 81 01 45 75 7D 24 1F CC C6 48 A0 B1 29 64 91 28 E4 7C 8E")) {  // 24102021
        #ifdef console
